...
mape_uncompressed, rmse_uncompressed, train_time_uncompressed, infer_time_uncompressed = train_and_evaluate(data, forecast_length)

compressed_data, scaler = prepare_data(compressed_file_path, target)

print("\nEvaluating Compressed Data:")
mape_compressed, rmse_compressed, train_time_compressed, infer_time_compressed = train_and_evaluate(compressed_data, forecast_length)
